...
switch (camara) {
    case '1':
        ...
        tucompra[0]=('Nikon D3500 con lente 18-55mm');
        ...
        tucompra[0]=('Nikon D7500 con lente 18-140mm');
        while (pago != "x" && pago != "X" && salir != "2") {
            switch (pago) {
                case '1':
        ...
        tucompra[0]=('Z fc con lente DX 16-50mm');
        while (pago != "x" && pago != "X" && salir != "2") {
            switch (pago) {
                case '1':
...
const cadena = tucompra.toString();
alert(cadena);